...
docker tag cocalc-lite:latest sagemathinc/cocalc-v2-lite:latest
docker tag cocalc-lite:latest sagemathinc/cocalc-v2-lite:`cat current_commit`
docker run --name=cocalc-test-lite -d -v ~/cocalc-test-lite:/projects -p 127.0.0.1:4044:443 sagemathinc/cocalc-v2-lite
